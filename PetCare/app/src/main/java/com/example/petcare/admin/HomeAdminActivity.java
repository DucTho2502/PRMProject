...
public class HomeAdminActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    //manager linerlayout
    private LinearLayout llCategoryHomeAdmin;
    ...
    private void bindingView() {
        ...
        llCategoryHomeAdmin = findViewById(R.id.llCategoryHomeAdmin);
    }
    ...
    private void bindingAction() {
        ...
        llCategoryHomeAdmin.setOnClickListener(this::onBtnCategoryUiClick);
    }

    private void onBtnCategoryUiClick(View view) {
        Intent intent = new Intent(HomeAdminActivity.this, CategoryAdminActivity.class);
