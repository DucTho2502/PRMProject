...
public class AccountProfile extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    //firebase
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.navHomeCustomer:
                startActivity(new Intent(AccountProfile.this, HomeCustomerActivity.class));
                break;
            case R.id.navLogoutCustomer:
                FirebaseAuth.getInstance().signOut();
                startActivity(new Intent(AccountProfile.this, LoginActivity.class));
                break;
...
//                    edt_password_account_profile.setText(customer.getPassword());
